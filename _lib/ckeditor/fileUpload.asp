...
<script type="text/javascript" src="/_lib/ckeditor/jquery-1.2.2.pack.js"></script>
<script type="text/javascript" src="/_lib/ckeditor/jquery.menu.js"></script>
<script type="text/javascript" src="/_lib/prototype.js"></script>
...
function layerview(str,filestr){
	...
	menu.addItems([
		...
		new jQuery.MenuItem({src: '다운로드', url:"/_lib/download.asp?downfile="+filestr+"&path=editordata"}, options),
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="menu" align="center">
			...
			<table border='0' cellspacing='0' cellpadding='0' class='menu' height='30' width='100%'>
				...
				<tr>
					<td align='right' bgcolor='#F7EFEF' height='30' style='padding-right:5px;'>
						<img src='/_lib/ckeditor/images/fileMannagerUpload.gif' align='absmiddle'>
						<input type="file" size="37" name="AttachFile" class="input">
						<img src='/_lib/ckeditor/images/fileManngerBtnUpload.gif' align='absmiddle' style='cursor:pointer;' onclick='filesendit()'>
					</td>
				</tr>
	...
	<tr>
		<td>
			<div id='fileDiv' style='padding:10px;'></div>
