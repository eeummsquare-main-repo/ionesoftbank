...
<!--#include virtual = _lib/imageDictionary.asp-->
<%
Dim page,pagesize,File_Path
Dim ObjFolder, Files, File
Dim totalpage, Count, Allrec
...
Function GetFileFormatByResult(FileName,uploadFolder)
	...
	IF FileName<>"" Then
		...
		IF UCASE(fileext)="JPG" OR UCASE(fileext)="BMP" OR UCASE(fileext)="GIF" OR UCASE(fileext)="JPEG" Then
			GetFileFormatByResult="<img src='/upload/"&UploadFolder&"/"&FileName&"' style='max-width:120px; max-height:90px;'>"
		Else
			GetFileFormatByResult="<img src='/_lib/fileimg/img_notimage.gif' width='120' height='90'>"
		End IF
	End IF
End Function
	...
	<tr>
		<td>
			<table cellpadding='0' cellspacing='0' width='100%'>
				...
				<tr>
					<td align='center' width='90%'><%=PT_PageLink("viewArea","''","yes")%></td>
				</tr>
			</table>
		</td>
	</tr>
