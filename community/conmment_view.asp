			...
			<table>
				...
				<tr>
					<th>
                        ...
                        <div class="view_info">
                            <div class="view_txt">
                                <p class="txt"><strong>구분</strong>&nbsp;전체</p>
                                <p class="txt"><strong>등록일</strong>&nbsp;2025-01-14</p>
                            </div>
                            <div class="view_right">
                                <p class="txt like_box"><button type="button" class="like_btn f0">좋아요 수</button> 000</p>
                                <p class="txt"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp;358</p>
                            </div>
