...
Else
%><!--#include virtual = /board/proc_boardlist_Hit.asp--><%
End IF
...
<div id="wrap">
	...
	<div id="container">
        ...
        <div class="multi-tab">
            ...
            <ul class="multi-list">
                <li><a href="conmment.asp">전체글보기</a></li>
                <li class="active"><a href="hit.asp">인기글보기</a></li>
            </ul>
        </div>

		<% IF mode="view" Then %>
		<!--#include virtual = /board/bbs_View_Hit.asp-->
		<% Else %>
		<!--#include virtual = /board/bbs_List_Hit.asp-->
		<% End IF %>
	</div>
