...
<%
GB_seoTitle = "공지사항 — 더존 ERP 소식 | 아이원소프트뱅크"
GB_seoDescription = "더존 ERP 뉴스·공지사항 — 신제품 출시, 업데이트, 세미나 일정 등 최신 ERP/그룹웨어 소식. Amaranth10·WEHAGO 신기능 발표 가장 빠르게."
GB_seoKeywords = "더존ERP뉴스,공지사항,Amaranth10업데이트,WEHAGO신기능,ERP세미나"
