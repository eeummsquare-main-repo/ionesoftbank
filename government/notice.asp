...
<%
GB_seoTitle = "공공기관·정부지원 ERP — 조달청 등록 안내 | 아이원소프트뱅크"
GB_seoDescription = "공공기관 ERP 도입 사례 — 중앙부처, 지자체, 공기업, 학교 등 공공 ERP 도입 사례. 조달청 등록 정보·구매 절차 안내."
GB_seoKeywords = "공공기관ERP,정부지원ERP,조달청ERP,지자체ERP,학교ERP,비대면바우처"
