...
editorYN=UploadForm("editorYN")
prePage=UploadForm("prePage")
Page=UploadForm("page")
seritemidx=UploadForm("seritemidx")
serstoreidx=UploadForm("serstoreidx")
...
IF editorYN=0 Then
	Content = ReplaceNoHtml(UploadForm("content"))
Else
...
Sql="INSERT INTO bbslist(editorYN,email,boardsort,writer,Title,Content,wip,regdate,boardidx,useridx,pwd,ref,reLevel) "
