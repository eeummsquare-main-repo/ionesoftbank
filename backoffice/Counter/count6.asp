...
sql = "select YY, MM, DD, Count(*) AS TotalVisit from (" & tmpDB & ") tmpDB Group By YY, MM, DD Order by YY, MM, DD"
Set Rs = DBcon.Execute(Sql)
...
Function PT_List()
	...
	IF IsArray(Allrec) Then
		For i=0 To Ubound(Allrec,2)
			...
			NDATE = Allrec(0,i) & "년 " & AddZero(Allrec(1,i)) & "월 " & AddZero(Allrec(2,i)) & "일"
			TotalVisit = Allrec(3,i)
