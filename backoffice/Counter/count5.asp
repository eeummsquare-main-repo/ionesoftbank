...
sql = "select WW, Count(*) AS TotalVisit from (" & tmpDB & ") tmpDB Group By WW Order by WW"
Set Rs = DBcon.Execute(Sql)
...
Function PT_List()
	Dim i
	Dim keys, TotalVisit, Percent, PercentSize

	IF IsArray(Allrec) Then
		For i=0 To Ubound(Allrec,2)
			keys = Allrec(0,i)
			TotalVisit = Allrec(1,i)
			...
			Response.Write "	<td><div style=""width:100%;overflow:hidden"">"&WeekdayName(keys)&"</div></td>"&Vbcrlf
