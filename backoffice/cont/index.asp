...
Sql = "SELECT idx, title, isDisplay, regdate, arrImgNm FROM project A WHERE proDiv="&serDiv&" "&strWhere&" ORDER BY title DESC, Idx DESC"
...
Function PT_ItemList
	...
	IF IsArray(Allrec) Then
		For i=0 To Ubound(Allrec,2)
			...
			imgTag = ""
			IF imgNm<>"" Then imgTag = "<div class=""listThumb""><a href=""javascript:openWindow(10,10,'../../_lib/imgview.asp?path=project&imgname="&imgNm&"','imgView','yes')""><img src=""/upload/project/"&getImageThumbFilename(imgNm)&"""></a></div>"
			...
			Response.Write "		<div class=""offTitle"">"&ReplaceNoHtml(title)&" 년</div>"&Vbcrlf
